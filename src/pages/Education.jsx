        ...
        <div className='xs2:p-2 xs:p-3 sm:p-4'>
          ...
          <div className='flex justify-between xs2:pb-1 md:pb-3'>
            <div className='flex'>
              ...
              <p className='pl-3 font-semibold xs2:text-base xs:text-lg md:text-xl md:pt-1'>Educations</p>
            </div>
            <div>
          ...
          <UserEducation school={"Strategy First University"} bachelor={"B.Sc"} period={"May 2022 to Feb 2023"} />
          <UserEducation school={"Strategy First University"} bachelor={"B.Sc"} period={"May 2022 to Feb 2023"} />
        </div>
      </div>
    </div>
