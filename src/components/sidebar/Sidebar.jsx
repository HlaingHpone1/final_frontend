...
const Sidebar = () => {
    ...
    // ]
  return (
    <div className={` ${open ? "w-72" : "w-20"} md: duration-300 h-screen bg-black p-5 pt-8 relative`}>
        ...
        <ul className='pt-5'>
            <li className='text-gray-300 flex items-center gap-x-4 cursor-pointer p-2 hover:bg-slate-700 rounded-md'>
            ...
            <li className='text-gray-300 flex items-center gap-x-4 cursor-pointer p-2 hover:bg-slate-700 rounded-md' onClick={logoutHandler}>
                <img src={img.logout} />
                <span 
