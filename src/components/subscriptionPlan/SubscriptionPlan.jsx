...
const SubscriptionPlan = ({planLogo , plan, info1, info2, info3, info4 , price}) => {
  return (
    <div className='xs2:w-56 xs:w-72 bg-sky-50 hover:ring ring-sky-200 rounded-md h-fit'>
        <div className='xs2:p-2 xs:p-4'>
            <div className='flex justify-center pb-4'>
                ...
                <p className='font-bold font-Roboto-Slab xs2:text-lg xs:text-xl'>{plan}</p>
            </div>
            ...
            <p className='text-center font-semibold text-xl py-3'>{price}</p>
